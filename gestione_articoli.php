...
<div class="container mt-5">
    ...
    <div class="card bg-light p-3 mb-4">
        <form id="filtri-form" action="gestione_articoli.php" method="GET">
...
$(document).ready(function() {
    ...
    function caricaProprieta(url, container, categoriaId, articoloId = 0) {
        ...
        container.html('<div class="spinner-border spinner-border-sm" role="status"></div>');
        $.ajax({
            ...
            success: function(response) {
                ...
                response.forEach(function(prop) {
                    ...
                    if (url.includes('get_proprieta_categoria')) {
    ...
    $('#filtro_categoria_id').on('change', function(event) {
        if (event.originalEvent) { // Azione dell'utente
            $('#filtri-form').submit();
        } else { // Trigger programmatico al caricamento pagina
